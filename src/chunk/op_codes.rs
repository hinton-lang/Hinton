...
impl OpCode {
    ...
    pub fn get(idx: &u8) -> Option<OpCode> {
        return match idx {
            ...
            32 => Some(OpCode::OP_NULLISH_COALESCING),
            33 => Some(OpCode::OP_PRE_INCREMENT),
            34 => Some(OpCode::OP_POST_INCREMENT),
            35 => Some(OpCode::OP_PRE_DECREMENT),
            36 => Some(OpCode::OP_POST_DECREMENT),
            37 => Some(OpCode::OP_ARRAY),
