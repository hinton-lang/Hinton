...
fn count_zeros(vm: &mut VM, this: Object, _: Vec<Object>) -> RuntimeResult {
  vm.push_stack(Object::Int(verify_int_object!(this, "count_zeros").count_zeros() as i64))
}
...
fn count_ones(vm: &mut VM, this: Object, _: Vec<Object>) -> RuntimeResult {
  vm.push_stack(Object::Int(verify_int_object!(this, "count_ones").count_ones() as i64))
}
