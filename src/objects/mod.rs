...
impl Object {
  ...
  pub fn type_name(&self) -> String {
    return match self {
      ...
      Self::Function(_) | Self::Native(_) | Self::Closure(_) | Self::BoundMethod(_) | Self::BoundNativeMethod(_) => {
        String::from("Function")
      }
      Self::Int(_) => String::from("Int"),
      Self::Iter(_) => String::from("Iter"),
      Self::None => String::from("Null"),
...
impl fmt::Display for Object {
  fn fmt(&self, f: &mut Formatter) -> Result<(), fmt::Error> {
    match *self {
      ...
      Object::None => f.write_str("\x1b[37;1mnull\x1b[0m"),
