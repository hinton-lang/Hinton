...
public enum TokenType {
    ...
    LOGICAL_AND, LOGICAL_OR, LOGICAL_EQ, LOGICAL_NOT_EQ, BITWISE_SHIFT_LEFT, BITWISE_SHIFT_RIGHT, BITWISE_AND,
    BITWISE_OR, BITWISE_NOT, BITWISE_XOR, RANGE_OPERATOR, AS_OPERATOR, INCREMENT, DECREMENT,
    // LOGICAL_IS, IN_OPERATOR,

    // ***** Keywords and Identifiers
    VAR_KEYWORD, FUNC_KEYWORD, CONST_KEYWORD, IF_KEYWORD, ELSE_KEYWORD, IDENTIFIER, FOR_KEYWORD, WHILE_KEYWORD,
    ...
    // ***** Types
    INTEGER_TYPE, FLOAT_TYPE, STRING_TYPE, CHARACTER_TYPE, BOOLEAN_TYPE, DICTIONARY_TYPE, SET_TYPE, FUNCTION_TYPE,
    ...
    // ***** Others
    QUESTION_MARK, BAD_CHARACTER, END_OF_FILE
}
