...
public enum TokenType {
    ...
    FOR_KEYWORD, WHILE_KEYWORD, RETURN_KEYWORD, LOOP_KEYWORD, BREAK_KEYWORD, CONTINUE_KEYWORD, INSTANCEOF_KEYWORD,
    IMPORT_KEYWORD, FROM_KEYWORD, EXPORT_KEYWORD, NEW_KEYWORD, INIT_KEYWORD, FINAL_KEYWORD, PUBLIC_KEYWORD,
    PRIVATE_KEYWORD, STATIC_KEYWORD, ABSTRACT_KEYWORD, OPTIONAL_KEYWORD, OVERRIDE_KEYWORD, SELF_KEYWORD,
    IMPLEMENTS_KEYWORD, EXTENDS_KEYWORD, ASYNC_KEYWORD, AWAIT_KEYWORD, YIELD_KEYWORD, ENUM_KEYWORD, STRUCT_KEYWORD,
    INTERFACE_KEYWORD, FLEX_KEYWORD, PRINT_KEYWORD,
