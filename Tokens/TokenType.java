...
public enum TokenType {
    ...
    IMPORT_KEYWORD, EXPORT_KEYWORD, NEW_KEYWORD, INIT_KEYWORD, READONLY_KEYWORD, PUBLIC_KEYWORD, PRIVATE_KEYWORD,
    STATIC_KEYWORD, ABSTRACT_KEYWORD, SELF_KEYWORD, IMPLEMENTS_KEYWORD, EXTENDS_KEYWORD, ASYNC_KEYWORD, AWAIT_KEYWORD,
    YIELD_KEYWORD, ENUM_KEYWORD,
